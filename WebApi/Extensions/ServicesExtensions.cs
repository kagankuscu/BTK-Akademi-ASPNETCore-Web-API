...
namespace WebApi.Extensions
{
    public static class ServicesExtensions
    {
        ...
        IConfiguration configuration) => services.AddDbContext<RepositoryContext>(options => options.UseSqlServer(configuration.GetConnectionString("sqlConnection")));
        ...
        public static void AddCustomerMediaTypes(this IServiceCollection services)
        {
            services.Configure<MvcOptions>(config => 
            {
                ...
                {
                    systemTextJsonOutputFormatter.SupportedMediaTypes.Add("application/vnd.btkakamed.hateoas+json");
                ...
                {
                    xmlOutputFormatter.SupportedMediaTypes.Add("application/vnd.btkakamed.hateoas+xml");
        ...
        public static void ConfigureResponceCaching(this IServiceCollection services) => services.AddResponseCaching();
